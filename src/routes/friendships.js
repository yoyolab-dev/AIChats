...
router.get('/friends', async (request, reply) => {
  // For now, treat friendships where userId = me and status accepted (or pending)
...
router.post('/friends', async (request, reply) => {
  ...
  // Create friendship (accepted directly for simplicity)
...
router.delete('/friends/:username', async (request, reply) => {
